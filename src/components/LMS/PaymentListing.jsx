...
import { getLMSPaymentById } from '../../API/LMSApi';

const LMSPaymentListing = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await getLMSPaymentById(Id);
        setPayment(result);
  ...
  return (
    <div>
      <Breadcrumb pageName="Offline LMS Payment Listing" />
...
export default LMSPaymentListing;
