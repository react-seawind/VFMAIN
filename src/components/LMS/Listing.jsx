...
import { deleteLMS, getAllLMS } from '../../API/LMSApi';
...
const LMSListing = () => {
  ...
  useEffect(() => {
    const mySearch = School.filter(
      (item) =>
        item.OfflineLMSSchoolName &&
        item.OfflineLMSSchoolName.toLowerCase().match(search.toLowerCase()),
    );
      ...
      <div>
        ...
        <Button
          ...
          onClick={() => {
            Swal.fire({
              title: 'Are you sure?',
              text: `You won't be able to revert this! Are you sure you want to delete ${rowData.OfflineLMSSchoolName}?`,
              icon: 'warning',
              ...
              if (result.isConfirmed) {
                ...
                Swal.fire(
                  'Deleted!',
                  `${rowData.OfflineLMSSchoolName} has been deleted.`,
                  'success',
                );
              }
            });
        ...
        <Button
          ...
          onClick={() => {
            Navigate(`/lms/payment/listing/${rowData.Id}`);
          }}
        />
      </div>
    );
  ...
  return (
    <div>
      <Breadcrumb pageName="Offline LMS School Listing" />
