...
import { getLMSById, updateLMSById } from '../../API/LMSApi';
...
const LMSEdit = () => {
  ...
  const fetchData = async () => {
    try {
      if (Id) {
        const SchoolData = await getLMSById(Id);
  ...
  return (
    <div>
      <Breadcrumb pageName="Offline LMS School Edit" />
